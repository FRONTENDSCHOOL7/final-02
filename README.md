...
## 8. Firestore 적용 및 활용
### 📚 Firestore 사용 이유
  프로젝트에서는 제공받은 API를 통해 사용자가 저장하고 싶은 책을 데이터베이스에 저장하고, 저장된 책 목록을 확인하거나 삭제하는 기능이 필요했습니다. 이러한 요구사항을 효율적으로 처리하기 위해 Firebase Firestore를 선택하게 되었습니다. Firestore는 실시간 동기화, 자동 확장성, 그리고 Firebase 플랫폼과의 간편한 통합이라는 장점이 있어 우리의 요구사항을 충족시키는 데 적합한 데이터베이스 솔루션이었습니다.
